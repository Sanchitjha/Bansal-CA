...
export class UserRoute implements IRoute {
  ...
  private initializeRoutes(): void {
    // Public auth endpoints — no authenticate/authorize.
    ...
    // Everything below requires a valid JWT + the listed permission.
    this.router.get("/", this.authenticate.handle, authorize("user.read"), this.controller.getUsers);
    this.router.get(
      "/external/:externalId",
    ...
    this.router.get("/:id", this.authenticate.handle, authorize("user.read"), this.controller.getUserById);
    this.router.post("/", this.authenticate.handle, authorize("user.write"), this.controller.createUser);
    this.router.put("/:id", this.authenticate.handle, authorize("user.write"), this.controller.updateUser);
    this.router.delete("/:id", this.authenticate.handle, authorize("user.write"), this.controller.deleteUser);
  }
}
